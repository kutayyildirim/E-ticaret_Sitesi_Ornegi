...
$query = "SELECT DISTINCT urunler.urunID, urunler.urunAdi, urunler.yazar, urunler.yayinevi, urunler.fiyat FROM degerlendirme JOIN urunler ON urunler.urunID = degerlendirme.urunID ORDER BY puan DESC";
